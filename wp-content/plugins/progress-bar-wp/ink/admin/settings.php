			...
			<td>
				...
				<div id="acc_title_bg_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						...
						<img src="<?php echo esc_url(wpshopmart_progress_bar_pro_directory_url.'assets/tooltip/img/test.png'); ?>">
					</div>
		    	</div>
			</td>
		</tr>
			...
			<td>	
				...
				<div id="font_family_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;max-width: 300px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('You can update Title and Description Font Family/Style from here. Select any one form these options.',progress_bar_wp_text_domain); ?></h2>
		...
		<tr>
			...
			<td>
				...
				<div id="pb_layout_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;max-width: 300px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('Testimonial Column Display layout',progress_bar_wp_text_domain); ?></h2>
					</div>
		    	</div>
			</td>
		</tr>
